...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mhealpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11811&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mhealpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mhealpy` can be installed with:

```
conda install mhealpy
```

It is possible to list all of the versions of `mhealpy` available on your platform with:
